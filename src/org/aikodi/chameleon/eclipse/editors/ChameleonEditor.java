...
import org.aikodi.chameleon.eclipse.presentation.annotation.ChameleonAnnotation;
...
//		   }
   ...
   public Object getAdapter(Class required) {
	...
	public void actionPerformed(ActionEvent arg0)  {
		//FIXME I disabled this because it wasn't used and it removed the verification errors.
//		IFile file = getFile();
...
//		Collection<ParseProblem> exceptions = getDocument().getParseErrors();
//		for(ParseProblem exception : exceptions){
...
//	}
	...
	/**
	 * The line of the given element will be highlighted and visible
	 * 
