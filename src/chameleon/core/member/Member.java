 ...
 */
public interface Member<E extends Member<E,P,S,F>, P extends Element, S extends Signature, F extends Member> extends TypeElement<E,Element>, Declaration<E,Element,S,F> {
