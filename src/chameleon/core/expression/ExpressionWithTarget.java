...
public interface ExpressionWithTarget<E extends ExpressionWithTarget, P extends Element> extends NamespaceElement<E,P>{
   ...
   */
public abstract InvocationTarget getTarget() throws LookupException;
